...
import '../presentation/admin_advertisements/admin_advertisements_screen.dart';
...
class AppRoutes {
  ...
  static Map<String, WidgetBuilder> routes = {
    ...
    searchAndFilters: (context) => const SearchAndFiltersScreen(),
    ...
    adminAdvertisements: (context) => const AdminAdvertisementsScreen(),
  };
}
